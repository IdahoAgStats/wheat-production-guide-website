...
##### **Table 4.1.** Spring and Winter Wheat Cultivars Released by University of Idaho currently in Production.
```{r}
...
DT::datatable(tbl_4_1, rownames = FALSE, 
              elementId = "tbl_ui_cultivar",
              caption = FALSE,
              filter = "top")
```
...
DT::datatable(tbl_4_2, 
              rownames = FALSE, 
              elementId = "tbl_ui_breeding",
              caption = NULL,
              filter = "none")
```
